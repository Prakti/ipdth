defmodule IpdthWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use IpdthWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Ipdth.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Ipdth.Accounts.generate_user_session_token(user)
