    ...
    <%= if @current_user do %>
      ...
      <div class="p-5 grid grid-cols-2 gap-4">
        <div class="relative rounded ring-1 ring-zinc-300 border-b-2 border-zinc-300 shadow-md p-2">
          ...
          <div class="absolute bottom-2 right-2 bg-green-200 rounded-full px-3 py-2 text-xs font-bold text-green-700 leading-none ring-1 ring-inset ring-green-500/40">
            Active
          </div>
        </div>
        <div class="relative rounded ring-1 ring-zinc-300 border-b-2 border-zinc-300 shadow-md p-2">
