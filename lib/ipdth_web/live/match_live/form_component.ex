defmodule IpdthWeb.MatchLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:start_date]} type="text" label="Start date" />
        <.input field={@form[:end_date]} type="text" label="End date" />
        <.input field={@form[:score_a]} type="number" label="Score a" />
        <.input field={@form[:score_b]} type="number" label="Score b" />
        <:actions>
